...
const createAdvancedStatTopic = (module: string, title: string, description: string): Topic => {
    ...
    return {
        id: slug,
        title,
        href: `/statistics/${slug}`, // Points to the /statistics/[slug] route
        icon: 'FunctionSquare',
        description,
        category: 'sub-topic',
        parent: module,
...
export const statisticsTopics: Topic[] = [
  ...
  // Parametric Tests (sub-topics of hypothesis testing)
  {
    id: 't-test',
    title: 'T-Test',
    href: '/hypothesis-testing-p-values/t-test',
    icon: 'FunctionSquare',
  ...
  },
  {
    id: 'z-test',
    title: 'Z-Test',
    href: '/hypothesis-testing-p-values/z-test',
    icon: 'FunctionSquare',
    description:
  ...
  },
  {
    id: 'anova',
    title: 'ANOVA',
    href: '/hypothesis-testing-p-values/anova',
    icon: 'FunctionSquare',
  ...
  },
  {
    id: 'f-test',
    title: 'F-Test',
    href: '/hypothesis-testing-p-values/f-test',
    icon: 'FunctionSquare',
  ...
  },
  {
    ...
    href: '/hypothesis-testing-p-values/pearson-correlation',
    icon: 'FunctionSquare',
    description:
  ...
  },
  {
    ...
    href: '/hypothesis-testing-p-values/chi-squared-test',
    icon: 'FunctionSquare',
    description:
  ...
  // Non-Parametric Tests (sub-topics of hypothesis testing)
  {
    ...
    href: '/hypothesis-testing-p-values/mann-whitney-u-test',
    icon: 'FunctionSquare',
    description:
  ...
  },
  {
    ...
    href: '/hypothesis-testing-p-values/kruskal-wallis-test',
    icon: 'FunctionSquare',
  ...
  },
  {
    ...
    href: '/hypothesis-testing-p-values/wilcoxon-signed-rank-test',
    icon: 'FunctionSquare',
    description:
  ...
  },
  {
    ...
    href: '/hypothesis-testing-p-values/spearmans-rank-correlation',
    icon: 'FunctionSquare',
    description:
  ...
  },
  {
    id: 'friedman-test',
    title: 'Friedman Test',
    href: '/hypothesis-testing-p-values/friedman-test',
    icon: 'FunctionSquare',
    description:
  ...
  },
  {
    ...
    href: '/hypothesis-testing-p-values/kolmogorov-smirnov-k-s-test',
    icon: 'FunctionSquare',
