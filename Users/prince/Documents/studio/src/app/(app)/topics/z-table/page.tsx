  ...
  return (
    <ChartContainer config={{}} className="h-[250px] w-full">
      <AreaChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
        ...
        <Tooltip
          content={<ChartTooltipContent indicator="line" labelFormatter={(value: number) => `Z: ${Number(value).toFixed(2)}`} formatter={(value: string | number) => [Number(value).toFixed(4), 'Density']} />}
        />
        <defs>
