...
import { generateNormalData, generateLogNormalData, getMean, getMedian, getMode, getStdDev, getSkewness, getKurtosis } from '@/lib/math/stats';
...
// --- Main Page Component ---
export default function DescriptiveStatisticsExplorerComponent() {
