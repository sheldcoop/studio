  ...
  return (
    <div>
      <ChartContainer config={{}} className="h-[300px] w-full">
        <Chart.AreaChart data={chartData.chartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
          ...
          <Chart.Area type="monotone" dataKey="density" stroke="hsl(var(--chart-1))" fill="url(#fillWeibull)" strokeWidth={2} dot={false} />
        </Chart.AreaChart>
      </ChartContainer>
    </div>
  );
...
export default function WeibullDistributionComponent() {
    ...
    return (
        <ProbabilityDistributionPageClient
            ...
            ChartComponent={WeibullDistributionChart}
        />
    );
}
