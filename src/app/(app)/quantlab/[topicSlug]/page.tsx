...
import NormalDistributionComponent from '@/app/(app)/quantlab/normal-distribution/component';
import BinomialDistributionComponent from '@/app/(app)/quantlab/binomial-distribution/component';
import PoissonDistributionComponent from '@/app/(app)/quantlab/poisson-distribution/component';
import BernoulliDistributionComponent from '@/app/(app)/quantlab/bernoulli-distribution/component';
import TDistributionComponent from '@/app/(app)/quantlab/students-t-distribution/component';
...
import ExponentialDistributionComponent from '@/app/(app)/quantlab/exponential-distribution/component';
import GeometricDistributionComponent from '@/app/(app)/quantlab/geometric-distribution/component';
import HypergeometricDistributionComponent from '@/app/(app)/quantlab/hypergeometric-distribution/component';
import NegativeBinomialDistributionComponent from '@/app/(app)/quantlab/negative-binomial-distribution/component';
import DiscreteUniformDistributionComponent from '@/app/(app)/quantlab/discrete-uniform-distribution/component';
import MultinomialDistributionComponent from '@/app/(app)/quantlab/multinomial-distribution/component';
import GammaDistributionComponent from '@/app/(app)/quantlab/gamma-distribution/component';
import BetaDistributionComponent from '@/app/(app)/quantlab/beta-distribution/component';
import CauchyDistributionComponent from '@/app/(app)/quantlab/cauchy-distribution/component';
import LaplaceDistributionComponent from '@/app/(app)/quantlab/laplace-distribution/component';
import WeibullDistributionComponent from '@/app/(app)/quantlab/weibull-distribution/component';
import LogisticDistributionComponent from '@/app/(app)/quantlab/logistic-distribution/component';
