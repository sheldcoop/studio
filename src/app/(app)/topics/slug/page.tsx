...
export default async function TopicPage({ params }: { params: { slug: string } }) {
  ...
  const dedicatedPages = ['hypothesis-testing-p-values', 'mental-math', 'linear-algebra', 't-test', 'z-test', 'anova', 'f-test', 'chi-squared-test', 'pearson-correlation', 'mann-whitney-u-test', 'kruskal-wallis-test', 'wilcoxon-signed-rank-test', 'spearmans-rank-correlation', 'friedman-test', 'kolmogorov-smirnov-k-s-test', 'ci', 'stat-toolkit'];
