    ...
    <div className="mx-auto max-w-5xl space-y-8">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="rounded-lg border p-4">
           ...
           <Alert>
              ...
              <AlertDescription>
                Our mission is to see if we have enough evidence in our data to **reject the skeptic's view (H₀)** and accept the new idea (Hₐ). From here, you can dive into a range of specific tests in our <Link href="/hypothesis-testing" className="font-semibold text-primary hover:underline">Quant's Detective Kit</Link>.
              </AlertDescription>
            </Alert>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Before we analyze the data, we must define what counts as "strong enough" evidence. This is deeply related to <Link href="/topics/confidence-intervals" className="font-semibold text-primary hover:underline">Confidence Intervals</Link>.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4 text-base leading-relaxed text-foreground/90">
      ...
      <Card>
        <CardHeader>
            ...
            <CardDescription>
                Even with this process, we can still make an error. It's crucial to understand the two types. For an interactive visualization, see our guide on <Link href="/topics/type-i-and-type-ii-errors" className="font-semibold text-primary hover:underline">Type I & Type II Errors</Link>.
            </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
