      ...
      datasets: [
        {
          label: 'Algo A (Old)',
          data: countsA,
          backgroundColor: `hsla(${theme.colors.light.chart1.h}, ${theme.colors.light.chart1.s}, ${theme.colors.light.chart1.l}, 0.7)`,
          borderColor: `hsl(${theme.colors.light.chart1.h}, ${theme.colors.light.chart1.s}, ${theme.colors.light.chart1.l})`,
          barPercentage: 1.0,
        ...
        },
        {
          label: 'Algo B (New)',
          data: countsB,
          backgroundColor: `hsla(${theme.colors.light.chart2.h}, ${theme.colors.light.chart2.s}, ${theme.colors.light.chart2.l}, 0.7)`,
          borderColor: `hsl(${theme.colors.light.chart2.h}, ${theme.colors.light.chart2.s}, ${theme.colors.light.chart2.l})`,
          barPercentage: 1.0,
          categoryPercentage: 1.0,
        },
      ],
