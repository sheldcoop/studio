...
import { Bar, BarChart as RechartsBarChart, CartesianGrid, Legend, Tooltip, XAxis, YAxis, Cell } from 'recharts';
...
export default function ChiSquaredTestPage() {
  const [activeTab, setActiveTab] = useState("goodness-of-fit");
            ...
            <Tabs defaultValue={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="goodness-of-fit" className="mt-6">
                ...
                <div className="mt-4 rounded-lg bg-background/50 p-4">
                  {activeTab === 'goodness-of-fit' && <DynamicGoodnessOfFitChart />}
                </div>
              </TabsContent>
              ...
              <TabsContent value="independence" className="mt-6">
                ...
                <div className="mt-4 rounded-lg bg-background/50 p-4">
                  {activeTab === 'independence' && <DynamicTestForIndependenceChart />}
                </div>
              </TabsContent>
              ...
              <TabsContent value="homogeneity" className="mt-6">
                ...
                <div className="mt-4 rounded-lg bg-background/50 p-4">
                    {activeTab === 'homogeneity' && <DynamicTestForHomogeneityChart />}
                </div>
              </TabsContent>
            </Tabs>
          </CardContent>
