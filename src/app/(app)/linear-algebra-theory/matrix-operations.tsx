...
const Lesson = ({ id, title, time, children }: { id: string; title: string; time: string; children: React.ReactNode; }) => (
    <section id={id} className="scroll-mt-20">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none text-base text-foreground/90 space-y-4">
            {children}
        </div>
    </section>
);
        ...
        <div className="flex flex-col lg:flex-row lg:gap-16">
            <div className="flex-1 min-w-0">
                ...
                <article className="space-y-12">
                    <Lesson id="addition-subtraction" title="Lesson 1: Matrix Addition & Subtraction" time="~15 min">
                    ...
                    <Lesson id="scalar-multiplication" title="Lesson 2: Scalar Multiplication" time="~15 min">
                    ...
                    <Lesson id="matrix-multiplication" title="Lesson 3: Matrix Multiplication" time="~15 min">
                    ...
                    <Lesson id="matrix-transpose" title="Lesson 4: The Matrix Transpose" time="~15 min">
