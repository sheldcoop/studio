...
export default function CovarianceMatrixPage() {
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 1: The Soul of Variance</CardTitle>
          <CardDescription>What are we really measuring?</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 2: The Two-Asset Portfolio - A Tale of Interaction</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 3: The Leap into Linear Algebra</CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Summary: The Triumph of Structure</CardTitle>
        </CardHeader>
        <CardContent>
