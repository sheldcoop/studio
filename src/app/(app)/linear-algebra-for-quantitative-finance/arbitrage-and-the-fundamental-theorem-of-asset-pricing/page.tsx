...
export default function ArbitragePage() {
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 1: The Financial Marketplace as a Vector Space</CardTitle>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 2: The Free Lunch - Defining Arbitrage</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <p className="font-semibold mt-2">The Mathematical Definition:</p>
            <p>An arbitrage opportunity exists if you can find a portfolio vector `h` such that:</p>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 3: The Fundamental Theorem of Asset Pricing (FTAP)</CardTitle>
