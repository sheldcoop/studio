...
export default function PortfolioOptimizationPage() {
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 1: The Two Dimensions of Investment - Risk and Return</CardTitle>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 2: The Formal Problem Statement</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 3: The Method of Lagrange Multipliers</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
            ...
            <p>To find the minimum, we take the derivative of <InlineMath math="\mathcal{L}" /> with respect to `w`, `λ₁`, and `λ₂` and set them to zero.</p>
        </CardContent>
      </Card>

      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 4: From Calculus to Linear Algebra - The Solution</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Summary: The Triumph of Optimization</CardTitle>
        </CardHeader>
        <CardContent>
