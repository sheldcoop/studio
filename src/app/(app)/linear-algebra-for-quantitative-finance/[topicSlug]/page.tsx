...
const EXCLUDED_SLUGS = new Set(['the-two-views-of-a-vector', 'vector-operations', 'the-dot-product-norms-and-angles', 'orthogonality', 'the-two-views-of-a-matrix', 'matrix-operations', 'matrix-multiplication', 'special-matrices', 'linear-combinations-and-span']);
