...
const EXCLUDED_SLUGS = new Set(['the-two-views-of-a-vector', 'vector-operations', 'the-dot-product-norms-and-angles', 'orthogonality', 'the-two-views-of-a-matrix', 'matrix-operations', 'matrix-multiplication', 'special-matrices', 'linear-combinations-and-span', 'linear-independence', 'basis-and-dimension', 'vector-spaces-and-subspaces', 'framing-the-problem-ax-b']);
