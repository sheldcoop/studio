...
export default function MarkovChainsPage() {
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 1: The Core Idea - Memoryless State Transitions</CardTitle>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 2: The Linear Algebra Connection - The Transition Matrix</CardTitle>
       ...
       <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 3: Predicting the Future - Matrix-Vector Multiplication</CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 4: The Long-Term Future - Matrix Powers</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
            <p>What about two years? `v₂ = v₁ * P = (v₀ * P) * P = v₀ * P²`. The state after `n` steps is:</p>
            <BlockMath math="v_n = v_0 P^n" />
            <p>The problem of predicting the long-term future has become the problem of calculating matrix powers.</p>
        </CardContent>
      </Card>

       <Card>
        <CardHeader>
          <CardTitle className="font-headline">Part 5: The Steady State - The Eigenvector Connection</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
