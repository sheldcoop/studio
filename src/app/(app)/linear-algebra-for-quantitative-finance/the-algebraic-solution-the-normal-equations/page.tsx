...
export default function NormalEquationsPage() {
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Step 1: Set up the (Unsolvable) System `Ax = b`</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
            <CardTitle className="font-headline">Step 2: Assemble the Pieces of the Normal Equations</CardTitle>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
            <CardTitle className="font-headline">Step 3: Solve the Normal Equations for `x̂`</CardTitle>
            <CardDescription>We now have a clean, solvable system: <InlineMath math="(A^TA)\hat{x} = A^Tb" />.</CardDescription>
        </CardHeader>
        <CardContent>
            <BlockMath math="\begin{bmatrix} 14 & 6 \\ 6 & 3 \end{bmatrix} \begin{bmatrix} m \\ c \end{bmatrix} = \begin{bmatrix} 13 \\ 6 \end{bmatrix}" />
            <p className="mt-4">This is a standard 2x2 system. Let's use elimination. The augmented matrix is:</p>
            <BlockMath math="\left[ \begin{array}{cc|c} 14 & 6 & 13 \\ 6 & 3 & 6 \end{array} \right]" />
            <p>Simplify Row 2 by dividing by 3:</p>
            <BlockMath math="\left[ \begin{array}{cc|c} 14 & 6 & 13 \\ 2 & 1 & 2 \end{array} \right]" />
      ...
      <Card>
        <CardHeader><CardTitle>Step 4: Interpret the Result</CardTitle></CardHeader>
        <CardContent>
            <p>The values <InlineMath math="m=0.5" /> and <InlineMath math="c=1" /> define the line of best fit for our data. The equation is:</p>
            <div className="rounded-lg border bg-muted/50 p-4 text-center my-4">
