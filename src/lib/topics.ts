...
export const allTopics: Topic[] = [
  ...
  { id: 'linear-algebra-vectors-and-spaces', title: 'Vectors and Spaces', href: '/topics/linear-algebra-vectors-and-spaces-for-quantitative-finance', icon: Waypoints, description: 'Learn about vector spaces for quantitative finance.', category: 'sub-topic', parent: 'la-module-1', status: 'completed', duration: 20 },
  { id: 'linear-algebra-matrices-and-operations', title: 'Matrices and Operations', href: '/topics/linear-algebra-matrices-and-operations-for-quantitative-finance', icon: Waypoints, description: 'An introduction to matrices and operations for quants.', category: 'sub-topic', parent: 'la-module-1', status: 'completed', duration: 25 },
  { id: 'linear-algebra-projection-vectors', title: 'Projection Vectors', href: '/topics/linear-algebra-projection-vectors-for-quantitative-finance', icon: Waypoints, description: 'Learn about projection vectors for quantitative finance.', category: 'sub-topic', parent: 'la-module-1', status: 'not-started', duration: 15 },
  
  // Module 2: Core Concepts
  { id: 'linear-algebra-matrix-transformations', title: 'Matrix Transformations', href: '/topics/linear-algebra-matrix-transformations-for-quantitative-finance', icon: Waypoints, description: 'Learn about matrix transformations for quants.', category: 'sub-topic', parent: 'la-module-2', status: 'completed', duration: 20 },
  { id: 'linear-algebra-solving-systems-of-equations', title: 'Solving Systems of Linear Equations', href: '/topics/linear-algebra-solving-systems-of-equations-for-quantitative-finance', icon: Waypoints, description: 'Learn how to solve systems of linear equations.', category: 'sub-topic', parent: 'la-module-2', status: 'completed', duration: 20 },
  { id: 'linear-algebra-eigenvalues-and-eigenvectors', title: 'Eigenvalues and Eigenvectors', href: '/topics/linear-algebra-eigenvalues-and-eigenvectors-for-quantitative-finance', icon: Waypoints, description: 'An introduction to eigenvalues and eigenvectors.', category: 'sub-topic', parent: 'la-module-2', status: 'in-progress', duration: 35 },
  { id: 'linear-algebra-matrix-decompositions', title: 'Key Matrix Decompositions (SVD, Cholesky)', href: '/topics/linear-algebra-matrix-decompositions-for-quantitative-finance', icon: Waypoints, description: 'Learn about key matrix decompositions like SVD and Cholesky.', category: 'sub-topic', parent: 'la-module-2', status: 'not-started', duration: 30 },
  
  // Module 3: Applications in ML & Statistics
  { id: 'linear-algebra-covariance-matrices', title: 'Covariance Matrices', href: '/topics/linear-algebra-covariance-matrices-for-quantitative-finance', icon: Waypoints, description: 'An introduction to covariance matrices.', category: 'sub-topic', parent: 'la-module-3', status: 'not-started', duration: 30 },
  { id: 'linear-algebra-principal-component-analysis', title: 'Principal Component Analysis (PCA)', href: '/topics/linear-algebra-principal-component-analysis-for-quantitative-finance', icon: Waypoints, description: 'Learn about Principal Component Analysis (PCA).', category: 'sub-topic', parent: 'la-module-3', status: 'not-started', duration: 45 },
  { id: 'linear-algebra-linear-regression-applications', title: 'Linear Regression applications', href: '/topics/linear-algebra-linear-regression-applications-for-quantitative-finance', icon: Waypoints, description: 'Learn about the applications of linear regression.', category: 'sub-topic', parent: 'la-module-3', status: 'not-started', duration: 30 },
  
  // Module 4: Applications in Quantitative Finance
  { id: 'linear-algebra-portfolio-optimization', title: 'Portfolio Optimization', href: '/topics/linear-algebra-portfolio-optimization-for-quantitative-finance', icon: Waypoints, description: 'Learn about portfolio optimization.', category: 'sub-topic', parent: 'la-module-4', status: 'not-started', duration: 45 },
  { id: 'linear-algebra-factor-models', title: 'Factor Models (CAPM)', href: '/topics/linear-algebra-factor-models-for-quantitative-finance', icon: Waypoints, description: 'An introduction to Factor Models (CAPM).', category: 'sub-topic', parent: 'la-module-4', status: 'not-started', duration: 30 },
  { id: 'linear-algebra-risk-management', title: 'Risk Management (VaR, Monte Carlo)', href: '/topics/linear-algebra-risk-management-for-quantitative-finance', icon: Waypoints, description: 'Learn about risk management techniques like VaR and Monte Carlo.', category: 'sub-topic', parent: 'la-module-4', status: 'not-started', duration: 45 },
