...
export const allTopics: Topic[] = [
  ...
  { id: 'la-vectors-spaces', title: 'Vectors and Spaces', href: '/topics/la-vectors-spaces', icon: Waypoints, description: 'Learn about vector spaces for quantitative finance.', category: 'sub-topic', parent: 'la-module-1', status: 'completed', duration: 20 },
  { id: 'la-matrices-ops', title: 'Matrices and Operations', href: '/topics/la-matrices-ops', icon: Waypoints, description: 'An introduction to matrices and operations for quants.', category: 'sub-topic', parent: 'la-module-1', status: 'completed', duration: 25 },
  { id: 'la-projection-vectors', title: 'Projection Vectors', href: '/topics/la-projection-vectors', icon: Waypoints, description: 'Learn about projection vectors for quantitative finance.', category: 'sub-topic', parent: 'la-module-1', status: 'not-started', duration: 15 },
  
  // Module 2: Core Concepts
  { id: 'la-matrix-transformations', title: 'Matrix Transformations', href: '/topics/la-matrix-transformations', icon: Waypoints, description: 'Learn about matrix transformations for quants.', category: 'sub-topic', parent: 'la-module-2', status: 'completed', duration: 20 },
  { id: 'la-solving-systems', title: 'Solving Systems of Linear Equations', href: '/topics/la-solving-systems', icon: Waypoints, description: 'Learn how to solve systems of linear equations.', category: 'sub-topic', parent: 'la-module-2', status: 'completed', duration: 20 },
  { id: 'la-eigenvalues-eigenvectors', title: 'Eigenvalues and Eigenvectors', href: '/topics/la-eigenvalues-eigenvectors', icon: Waypoints, description: 'An introduction to eigenvalues and eigenvectors.', category: 'sub-topic', parent: 'la-module-2', status: 'in-progress', duration: 35 },
  { id: 'la-decompositions', title: 'Key Matrix Decompositions (SVD, Cholesky)', href: '/topics/la-decompositions', icon: Waypoints, description: 'Learn about key matrix decompositions like SVD and Cholesky.', category: 'sub-topic', parent: 'la-module-2', status: 'not-started', duration: 30 },
  
  // Module 3: Applications in ML & Statistics
  { id: 'la-covariance-matrices', title: 'Covariance Matrices', href: '/topics/la-covariance-matrices', icon: Waypoints, description: 'An introduction to covariance matrices.', category: 'sub-topic', parent: 'la-module-3', status: 'not-started', duration: 30 },
  { id: 'la-pca', title: 'Principal Component Analysis (PCA)', href: '/topics/la-pca', icon: Waypoints, description: 'Learn about Principal Component Analysis (PCA).', category: 'sub-topic', parent: 'la-module-3', status: 'not-started', duration: 45 },
  { id: 'la-linear-regression', title: 'Linear Regression applications', href: '/topics/la-linear-regression', icon: Waypoints, description: 'Learn about the applications of linear regression.', category: 'sub-topic', parent: 'la-module-3', status: 'not-started', duration: 30 },
  
  // Module 4: Applications in Quantitative Finance
  { id: 'la-portfolio-optimization', title: 'Portfolio Optimization', href: '/topics/la-portfolio-optimization', icon: Waypoints, description: 'Learn about portfolio optimization.', category: 'sub-topic', parent: 'la-module-4', status: 'not-started', duration: 45 },
  { id: 'la-factor-models', title: 'Factor Models (CAPM)', href: '/topics/la-factor-models', icon: Waypoints, description: 'An introduction to Factor Models (CAPM).', category: 'sub-topic', parent: 'la-module-4', status: 'not-started', duration: 30 },
  { id: 'la-risk-management', title: 'Risk Management (VaR, Monte Carlo)', href: '/topics/la-risk-management', icon: Waypoints, description: 'Learn about risk management techniques like VaR and Monte Carlo.', category: 'sub-topic', parent: 'la-module-4', status: 'not-started', duration: 45 },
