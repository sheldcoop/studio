...
export const probabilityAdvancedTopics: Topic[] = [
    ...
    createTopic({
        ...
        previousSlugs: ['bayes-theorem-deep-dive'],
        icon: 'BrainCircuit',
    ...
    createTopic({
        ...
        previousSlugs: ['central-limit-theorem-deep-dive'],
    ...
    createTopic({
        parent: 'prob-quant-mod-6',
        id: 'introduction-to-ito-calculus',
        title: "Introduction to Itô Calculus",
        href: '/topics/stochastic-calculus-itos-lemma',
        previousSlugs: ['stochastic-calculus-itos-lemma-deep-dive'],
        icon: 'AreaChart',
