...
const foundationModules = allTopics.filter(t => t.parent === 'statistics-for-quantitative-finance' && t.id.startsWith('stats-'));
                 ...
                 <Card className="flex flex-col md:col-span-1">
                    ...
                    <CardContent className="flex-1">
                       <Link href="/paths/statistics-for-quantitative-finance" className="block rounded-lg border bg-background p-4 transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/20">
                            <h4 className="font-semibold">View All Foundational Modules</h4>
                            <p className="text-sm text-muted-foreground">Learn the core concepts of statistical analysis from all three tiers.</p>
                        </Link>
                    </CardContent>
                </Card>
